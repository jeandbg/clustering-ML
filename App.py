...
encoder = joblib.load('encoder.pkl')   # ok,então era pra isso que salvamos os arquivos .pkl 
...
def processar_prever (df):
    encoded_sexo = encoder.transform(df[['sexo']])  #aqui, apenas transform e não .fit_transform, como no colab? qual a diferença?
                                                    #testei com fit_transform e funciona igual. Por quê?
